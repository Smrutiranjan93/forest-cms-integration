...
@Component({
  selector: 'app-chandakawebdirectory',
  templateUrl: './chandakawebdirectory.component.html',
  styleUrls: ['./chandakawebdirectory.component.scss']
})
export class ChandakawebdirectoryComponent implements OnInit {
