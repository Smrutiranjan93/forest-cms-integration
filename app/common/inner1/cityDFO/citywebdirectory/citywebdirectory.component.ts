...
@Component({
  selector: 'app-citywebdirectory',
  templateUrl: './citywebdirectory.component.html',
  styleUrls: ['./citywebdirectory.component.scss']
})
export class CitywebdirectoryComponent implements OnInit {
