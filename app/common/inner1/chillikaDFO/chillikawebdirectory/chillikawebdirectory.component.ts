...
@Component({
  selector: 'app-chillikawebdirectory',
  templateUrl: './chillikawebdirectory.component.html',
  styleUrls: ['./chillikawebdirectory.component.scss']
})
export class ChillikawebdirectoryComponent implements OnInit {
