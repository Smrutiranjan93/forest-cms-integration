...
@Component({
  selector: 'app-webdirectory',
  templateUrl: './webdirectory.component.html',
  styleUrls: ['./webdirectory.component.scss']
})
export class WebdirectoryComponent implements OnInit {
