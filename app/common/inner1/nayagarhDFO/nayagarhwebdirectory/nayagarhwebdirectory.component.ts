...
@Component({
  selector: 'app-nayagarhwebdirectory',
  templateUrl: './nayagarhwebdirectory.component.html',
  styleUrls: ['./nayagarhwebdirectory.component.scss']
})
export class NayagarhwebdirectoryComponent implements OnInit {
