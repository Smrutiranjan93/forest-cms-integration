...
@Component({
  selector: 'app-mangrovewebdirectory',
  templateUrl: './mangrovewebdirectory.component.html',
  styleUrls: ['./mangrovewebdirectory.component.scss']
})
export class MangrovewebdirectoryComponent implements OnInit {
