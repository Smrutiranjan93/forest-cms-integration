...
@Component({
  selector: 'app-bhadrakwebdirectory',
  templateUrl: './bhadrakwebdirectory.component.html',
  styleUrls: ['./bhadrakwebdirectory.component.scss']
})
export class BhadrakwebdirectoryComponent implements OnInit {
