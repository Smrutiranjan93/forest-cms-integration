...
@Component({
  selector: 'app-khurdhawebdirectory',
  templateUrl: './khurdhawebdirectory.component.html',
  styleUrls: ['./khurdhawebdirectory.component.scss']
})
export class KhurdhawebdirectoryComponent implements OnInit {
